...
// 2021-02-18 19:16:50.771886773 +0100 CET m=+0.000260398
...
func (c *Client) PsiphonConfig(ctx context.Context, req *model.PsiphonConfigRequest) (model.PsiphonConfigResponse, error) {
	token, err := c.maybeRefreshToken(ctx)
	if err != nil {
		return nil, err
	}
	api := newPsiphonConfigAPI(c, token)
