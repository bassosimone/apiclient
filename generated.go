...
// 2021-02-22 11:44:06.575318716 +0100 CET m=+0.000272405
...
func newCheckReportIDAPI(c *Client) *checkReportIDAPI {
	var clnt HTTPClient = c.httpClient
...
func (api *checkReportIDAPI) call(ctx context.Context, in *model.CheckReportIDRequest) (*model.CheckReportIDResponse, error) {
	...
	return api.newResponse(api.httpClient.Do(req))
}
...
func (c *Client) PsiphonConfig(ctx context.Context, req *model.PsiphonConfigRequest) (model.PsiphonConfigResponse, error) {
	la := &psiphonConfigAPILoginAdapter{req: req}
	if err := c.doWithLoginAdapter(ctx, la); err != nil {
		return nil, err
	}
	return la.resp, nil
}

type psiphonConfigAPILoginAdapter struct {
	mu   sync.Mutex
	req  *model.PsiphonConfigRequest
	resp model.PsiphonConfigResponse
}

func (la *psiphonConfigAPILoginAdapter) call(ctx context.Context, clnt *Client, token string) error {
	defer la.mu.Unlock()
	la.mu.Lock()
	if la.resp != nil {
		return errors.New("apiclient: call already succeeded")
	}
	api := newPsiphonConfigAPI(clnt, token)
	resp, err := api.call(ctx, la.req)
	if err != nil {
		return err // we may need to try with another token
	}
	la.resp = resp
	return nil
}
...
func newPsiphonConfigAPI(c *Client, token string) *psiphonConfigAPI {
	var clnt HTTPClient = c.httpClient
	clnt = &cacheClient{
		HTTPClient: clnt,
		KVStore:    c.kvStore,
...
func (api *psiphonConfigAPI) call(ctx context.Context, in *model.PsiphonConfigRequest) (model.PsiphonConfigResponse, error) {
	...
	authorization := newAuthorizationHeader(api.token)
...
func (c *Client) TorTargets(ctx context.Context, req *model.TorTargetsRequest) (model.TorTargetsResponse, error) {
	la := &torTargetsAPILoginAdapter{req: req}
	if err := c.doWithLoginAdapter(ctx, la); err != nil {
		return nil, err
	}
	return la.resp, nil
...
type torTargetsAPILoginAdapter struct {
	mu   sync.Mutex
	req  *model.TorTargetsRequest
	resp model.TorTargetsResponse
}

func (la *torTargetsAPILoginAdapter) call(ctx context.Context, clnt *Client, token string) error {
	defer la.mu.Unlock()
	la.mu.Lock()
	if la.resp != nil {
		return errors.New("apiclient: call already succeeded")
	}
	api := newTorTargetsAPI(clnt, token)
	resp, err := api.call(ctx, la.req)
	if err != nil {
		return err // we may need to try with another token
	}
...
func newTorTargetsAPI(c *Client, token string) *torTargetsAPI {
	var clnt HTTPClient = c.httpClient
	clnt = &cacheClient{
		HTTPClient: clnt,
		KVStore:    c.kvStore,
