...
// 2021-02-19 12:17:40.941469845 +0100 CET m=+0.115092151
...
func TestCheckReportIDWith401(t *testing.T) {
	clnt := &mockableHTTPClient{Resp: &http.Response{StatusCode: 401}}
	api := &checkReportIDAPI{
		BaseURL:    "https://ps1.ooni.io",
		HTTPClient: clnt,
	}
...
func TestClientWithHandlerForCheckReportID(t *testing.T) {
	...
	// check for the path
	if handler.url.Path != "/api/_/check_report_id" {
		t.Fatal("sent an invalid path")
	}
}
...
func TestClientWithHandlerForCheckIn(t *testing.T) {
	...
	// check for the path
	if handler.url.Path != "/api/v1/check-in" {
		t.Fatal("sent an invalid path")
	}
}
...
func TestClientWithHandlerForMeasurementMeta(t *testing.T) {
	...
	// check for the path
	if handler.url.Path != "/api/v1/measurement_meta" {
		t.Fatal("sent an invalid path")
	}
}
...
func TestClientWithHandlerForTestHelpers(t *testing.T) {
	...
	// check for the path
	if handler.url.Path != "/api/v1/test-helpers" {
		t.Fatal("sent an invalid path")
	}
}
...
func TestClientWithHandlerForPsiphonConfig(t *testing.T) {
	...
	// check for the path
	if handler.url.Path != "/api/v1/test-list/psiphon-config" {
		t.Fatal("sent an invalid path")
	}
}

func TestClientDoWithLoginAdapterFailureForPsiphonConfig(t *testing.T) {
	req := &model.PsiphonConfigRequest{}
	ff := &fakeFill{}
	ff.fill(req)
	clnt := &Client{
...
func TestClientWithHandlerForTorTargets(t *testing.T) {
	...
	// check for the path
	if handler.url.Path != "/api/v1/test-list/tor-targets" {
		t.Fatal("sent an invalid path")
	}
}

func TestClientDoWithLoginAdapterFailureForTorTargets(t *testing.T) {
	req := &model.TorTargetsRequest{}
	ff := &fakeFill{}
	ff.fill(req)
	clnt := &Client{
...
func TestClientWithHandlerForURLs(t *testing.T) {
	...
	// check for the path
	if handler.url.Path != "/api/v1/test-list/urls" {
		t.Fatal("sent an invalid path")
	}
}
...
func TestClientWithHandlerForSubmitMeasurement(t *testing.T) {
	...
	// check for the path
	tmpl := template.Must(template.New("t").Parse("/report/{{ .ReportID }}"))
	var tmplsb strings.Builder
	if err := tmpl.Execute(&tmplsb, req); err != nil {
		t.Fatal(err)
	}
	if handler.url.Path != tmplsb.String() {
		t.Fatal("sent an invalid path")
	}
}
